...
files['frontend/src/components/Layout.tsx'] = `import React, { useEffect, useState } from 'react';
...
files['frontend/src/pages/LoginPage.tsx'] = `import React, { useState } from 'react';
...
files['frontend/src/components/AccountCard.tsx'] = `import React, { useState } from 'react';
...
console.log('\n✅ כל הקבצים עודכנו!');
console.log('עכשיו הריצי:');
console.log('  git add .');
console.log('  git commit -m "Redesign: clean banking UI"');
console.log('  git push https://rikileybo-crypto@github.com/rikileybo-crypto/Riki_Finance.git main');
